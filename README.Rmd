...
2. Good practical books/resources on statistics in R: [1](https://book.stat420.org/), [2](https://stats.oarc.ucla.edu/other/dae/),[3](https://methodenlehre.github.io/intro-to-rstats/index.html).    
...
This is a basic example that shows you how the main function `equalparts()` works:
...
4. means - mean of independent interval of equal part (scatter plot between Freq_1 and means is the basic plot that is pictured earlier).  
