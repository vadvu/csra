...
4. Chi-squared statistics with stars indicating the p <0.01 level of significance (note, in this function $^{***}p<0.01,^{**}p<0.05,^{*}p<0.1$)  
...
where $\pi$ is an estimated probability, and $z_{a/2} = 1.96$ due to 95% CI.  
