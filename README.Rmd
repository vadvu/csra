...
2. Good practical books/resources on statistics in R: [1](https://book.stat420.org/), [2](https://stats.oarc.ucla.edu/other/dae/), [3](https://methodenlehre.github.io/intro-to-rstats/index.html), [4](https://murraylax.org/rtutorials/).    
