...
* Bootstrap of a midpoint ($\frac{-\beta_1}{2\times \beta_2}$) for constructing CI. This is optional, but highly recommended stage. Now it works unstable in the function...   
