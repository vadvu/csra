...
exposing the matrix is an extremely difficult task. There is no analytical solution for optimization, so iterative process is used with *Maximum Likelihood* (ML) estimator $L$: 
